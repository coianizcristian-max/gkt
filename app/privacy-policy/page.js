      ...
      <div className="legal-content">
        ...
        <section>
          ...
          <p>
            ...
            Codice Fiscale: CNZCST76T22Z133X<br />
        ...
        <section>
          ...
          <ul>
            ...
            <li><strong>Dati di contatto</strong>: messaggi inviati tramite il modulo contatto allenatori o tramite la sezione Suggerimenti (nome, email, telefono, messaggio).</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <table className="legal-table">
            ...
            <tbody>
              ...
              <tr><td>Invio comunicazioni di servizio (notifiche, inviti, risposte ai suggerimenti)</td><td>Esecuzione del contratto (art. 6.1.b GDPR)</td></tr>
              <tr><td>Invio della newsletter</td><td>Consenso (art. 6.1.a GDPR)</td></tr>
        ...
        <section>
          ...
          <ul>
            ...
            <li>Messaggi di contatto e suggerimenti: 2 anni dall&apos;ultimo scambio.</li>
            <li>Iscrizione alla newsletter: fino alla revoca del consenso (disiscrizione).</li>
          </ul>
        </section>

        <section>
          <h2>5. Destinatari dei dati</h2>
          <p>I dati personali possono essere comunicati a fornitori terzi che agiscono come responsabili del trattamento:</p>
          <ul>
            ...
            <li><strong>Resend Inc.</strong> (USA) — invio di email transazionali e di servizio (es. notifiche, newsletter).</li>
            <li><strong>register.it</strong> (Italia) — gestione caselle di posta elettronica del dominio.</li>
          </ul>
        ...
        <section>
          ...
          <p>
            Per esercitare i tuoi diritti, scrivi a <a href="mailto:info@gkseason.it">info@gkseason.it</a>.
