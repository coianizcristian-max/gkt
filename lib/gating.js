...
/**
 * Lato server: controlla se un utente ha un abbonamento attivo.
 *
 * ⚠️ COMPORTAMENTO ATTUALE (da rivedere): il portiere NON ha un piano proprio,
 * eredita quello dell'allenatore titolare (getOwnerId). Questa è la ragione per
 * cui, oggi, il prezzo "Portiere" configurato non viene di fatto usato dal
 * gating. Il cambio verso "portiere con abbonamento proprio + prova propria" è
 * documentato nel piano allegato e va fatto insieme alla logica di prova.
 */
