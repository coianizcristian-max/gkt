  ...
  const sezioniAllenatore = [
    ...
    },
    {
      ...
      domande: [
        ...
        { q: 'Come accorpo due categorie nello stesso allenamento?', a: 'Nel form dell\'allenamento della categoria "ospite", usa il campo "Accorpata con" e seleziona l\'altra categoria. L\'orario viene ereditato automaticamente da quella categoria (essendo la stessa seduta), e nel calendario la categoria che gestisce gli esercizi ha la cornice verde, quella accorpata la cornice gialla.' },
